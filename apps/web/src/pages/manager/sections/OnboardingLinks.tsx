                                        ...
                                        <Box display="flex" justifyContent="space-between" alignItems="center">
                                            <Box>
                                                <Box display="flex" alignItems="center" gap={1}>
                                                    <Typography variant="body2" fontWeight={500} sx={{ textDecoration: link.used ? 'line-through' : 'none' }}>
                    ...
                    <Paper sx={{ p: 3 }}>
                        <Box display="flex" justifyContent="space-between" alignItems="center" mb={2}>
                            ...
                            <IconButton
                                size="small"
                                onClick={loadClients}
                                disabled={isLoadingClients || !managerAddress}
                            >
                                <RefreshIcon />
                            </IconButton>
                        </Box>
                        ...
                        {isLoadingClients ? (
                            ...
                            <Alert severity="info">
                                No clients yet. Share your onboarding link to get started!
                            </Alert>
                        ) : (
                            <TableContainer>
                                <Table size="small">
