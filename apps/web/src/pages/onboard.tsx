...
export default function ClientOnboarding() {
  ...
  // Delegation Hook
  const { isLoading: isDelegating, error: delegationError, getManager, getDelegation } = useDelegationModule()
  ...
  const handleEnableAndApprove = async () => {
    ...
    const hash = await enableModulesAndDelegate(managerAddress as `0x${string}`, PERMISSION.ALL)
    if (hash) {
      setTxHash(hash)
      setActiveStep(3)
    }
              ...
              <StepContent>
                <Alert severity="info" sx={{ mb: 2 }}>
                  ...
                  <Typography variant="body2" color="text.secondary" sx={{ mt: 1 }}>
                    ...
                    <br />• Allows manager to trade on your behalf
                  </Typography>
                </Alert>
                ...
                >
                  {is7702Loading ? 'Upgrading...' : state7702.isDelegated ? 'Continue' : 'Upgrade to Smart Account'}
                </Button>
              </StepContent>
            </Step>
          ...
          <Stepper activeStep={activeStep} orientation="vertical">
            ...
            <Step>
              ...
              <StepContent>
                ...
                <Button variant="contained" onClick={handleApproveTokens} disabled={isSafeLoading}>
                  Approve Tokens
                </Button>
              </StepContent>
            </Step>
